...
Miner.prototype = {
    ...
    setBlockAndBuffer:function(currentBlockTemplate,difficultyBuffer){
        this.currentBlockTemplate = currentBlockTemplate;
        this.difficultyBuffer = difficultyBuffer;
    },
    getJob: function(){
        var currentBlockTemplate = this.currentBlockTemplate;
        ...
        var target = (function(self){
            ...
            var diffBuff = self.difficultyBuffer.div(self.difficulty).toBuffer();
